    ...
    <ClickOutside onClickOutside={(e) => handleClickOutside(e)}>
      <div className="sticky top-0 z-10">
        <div className="relative bg-white ">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <Body className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10 border-0">
              ...
              <div className="-mr-2 -my-2 md:hidden">
                <button
                  onClick={(e) => togglex(setToggleburger(!toggleburger))}
                  type="button"
              ...
              <nav className="hidden md:flex space-x-10">
                <div className="relative">
                  <button
                    onClick={(e) => togglex(setToggle(!toggle))}
                    type="button"
                  ...
                  <div className="absolute z-10 -ml-4 mt-3 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2">
                    <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                      <div
                        onBlur={(e) => togglex(setToggle(!toggle))}
                        className={
                          toggle
                            ? "relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8"
                            : "hidden relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8"
                        }
                      >
                        <a
                          href="#"
                ...
                <div className="relative">
                  <button
                    onClick={(e) => togglex(setToggleMore(!togglemore))}
                    type="button"
                    className="group bg-white rounded-md text-gray-500 inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                  >
                    <span>More</span>
                  ...
                  <div
                    onBlur={(e) => togglex(setToggleMore(!togglemore))}
                    className={
                      togglemore
                        ? "absolute z-10 left-1/2 transform -translate-x-1/2 mt-3 px-2 w-screen max-w-md sm:px-0"
                        : "absolute z-10 left-1/2 transform -translate-x-1/2 mt-3 px-2 w-screen max-w-md sm:px-0 hidden"
                    }
                  >
                    <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
          ...
          <div
            // onBlur={(e) => togglex(setToggleburger(!toggleburger))}
            className={
              toggleburger
                ? "absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden"
                : "hidden absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden"
            }
          >
            <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
              <div className="pt-5 pb-6 px-5">
                <div className="flex items-center justify-between">
                  ...
                  <div className="-mr-2">
                    <button
                      onClick={() => togglex(setToggleburger(!setToggleburger))}
                      type="button"
                      className="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500"
                    >
