              ...
              <div className="article-row">
                ...
                <div className="article-card-left">
                  <div>
                    <img
                      className="article-image"
                      src="./images/1-340x220.jpg"
                      alt=""
                    />
                    <h2 className="article-title">
                      <a href="">Use Travel To Make Someone Fall In Love With You</a>
                    </h2>
                    <p className="article-body">
                      Far far away, behind the word mountains, far from the
                      countries...
              ...
              <div className="article-row">
                <div className="article-card-right">
                  <div>
                    <img
                      className="article-image"
                      src="./images/3-340x220.jpg"
                      alt=""
                    />
                    <h2 className="article-title">
                      <a href="">What Google Teach About Travel</a>
                    </h2>
                    <p className="article-body">
                      Far far away, behind the word mountains, far from the
                      countries...
                ...
                <div className="article-card-left">
                  <div>
                    <img
                      className="article-image-"
                      src="./images/4-340x220.jpg"
                      alt=""
                    />
                    <h2 className="article-title">
                      <a href="">The Hidden Mystery Behind Travel</a>
                    </h2>
                    <p className="article-body">
                      Far far away, behind the word mountains, far from the
                      countries...
            ...
            <div className="ml-2 md:ml-4 mr-2">
              <div className="mt-20 sm:mt-0 text-center">
                <img
                  ...
                  alt=""
                />
                <h2 className="font-light text-xl my-5">We are</h2>
                <p className="article-body">
                  Hi! Welcome to Fuvahmulah Travel, your guide to the most beautiful
                  and unique island in Maldives.
                </p>
              </div>
              <div className="mt-20">
              ...
              <div className="mt-10">
                ...
                <ul>
                  <li className="flex">
                    <a
                      href=""
                      className="text-gray-900 font-thin font-serif text-lg py-2 block flex-1"
                    >
                      Travel Tips
                    </a>
                    <span className="text-gray-700 text-lg font-thin p-2">2</span>
                  </li>
                  <li className="flex">
                    <a
                      href=""
                    ...
                    <span className="text-gray-700 text-lg font-thin p-2">10</span>
                  </li>
                  <li className="flex">
                    <a
                      href=""
                    ...
                    <span className="text-gray-700 text-lg font-thin p-2">7</span>
                  </li>
                  <li className="flex">
                    <a
                      href=""
                    ...
                    <span className="text-gray-700 text-lg font-thin p-2">4</span>
                  </li>
                </ul>
              </div>
              <div className="mt-10">
