...
const about = () => {
  return (
    <>
      <div
        className="transform -translate-x-84  lgx:-translate-x-20 left-0 lgx:-left-4 delay-700 duration-700 ease-in-out flex absolute w-full -bottom-3/4
      "
      >
        <Fade left>
          <img
            ...
            alt=""
            srcset=""
            className="transform -translate-x-84  lgx:-translate-x-20 delay-700 duration-700 ease-in-out  z-10 md:w-52 lg:w-96 "
          />
        </Fade>
      </div>
      <div
        className="translate-x-84 lg:-translate-x-96 absolute w-full h-full -right-4
      "
      >
        <Fade right>
          <img
            ...
            alt=""
            srcset=""
            className="transform translate-x-84 lgx:translate-x-0 delay-700 duration-700 ease-in-out w-96 flex absolute -bottom-1/4 -z-10 md:w-52 lg:w-96 -right-40"
          />
        </Fade>
      </div>
      <Zoom bottom>
        <div className=" flex absolute w-full h-auto lgx:-left-4  top-2/4">
          {/* <Fade left> */}
          <Imgx
            src={process}
            alt=""
        ...
        <main className="w-full">
          <div class="block md:flex">
            <div class="sm:w-full md:w-2/6 m-3">
              <div class="w-100 h-100 col-md-12">
                {/* <div class="roundedx  -c mx-auto"></div> */}
                <div class="flex justify-center ...">
                  <div
                    className={
                      `${styles.roundedx}` + " inline-block align-middle m-2"
                    }
                  ></div>
                </div>
            ...
            <div class="block md:w-3/4 m-4">
              ...
              <div className="">
                ...
                <p>
                  ...
                  Software Engineer bukanlah jalan yang mudah, karena diperjalanan
                  nya dipenuhi lika-liku. Berawal dari melihat teman yang bekerja
                  remote dari rumah kos adalah awal ketertarikan terhadap Software
                  Engineer. Semster 7 pertengahan saat sedang mengerjakan skripsi
                  akhirnya aku memutuskan untuk belajar secara mandiri. Bahasa
                  pemrograman yang pertamakali saya pelajari adalah Python dengan
                  framework Django. Sampai akhirnya saya diterima magang kemudian
                  bekerja selama satu tahun di startup Surbaya di bidang fintech. Dan
                  setelah bekerja selama lebih dari setahun saya memutuskan untuk
                  resign dan mengikuti programm dari Glints x Binar agar menambah
                  kompetensi saya dan tentunya relasi!
                </p>
              </div>
            </div>
          </div>
        ...
        "
          ...
          <Zoom bottom>
            <div className="  pt-2 grid gap-4 md:grid-cols-3 grid-cols-1">
