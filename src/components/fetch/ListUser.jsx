...
class Home extends Component {
  ...
  componentDidMount() {
    ...
    let random = []
    let turkey = []
    Axios("https://randomuser.me/api/?results=500")
      .then((res) =>
  ...
  render() {
    ...
    return (
      <div>
        <div className="text-lg grid-cols-1 font-semibold pt-3">
          <span className="">Germany List</span>
        </div>
        <hr />
        <div className="flex justify-center boxWhite grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 mt-8 gap-2">
          {jerman.length > 0 ? (
            jerman.slice(0, 5).map((item) => {
              const {
                id,
                firstName,
                lastName,
        ...
        <div className="text-lg grid-cols-1 font-semibold ">
          <span className="">Turkey List</span>
        </div>
        <hr />
        <div className="flex justify-center boxWhite grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 mt-8 gap-2">
          {turkey.length > 0 ? (
            turkey.slice(0, 5).map((item) => {
              const {
                id,
                firstName,
                lastName,
              ...
              return (
                <div className="h-56 py-4 px-3 bg-white shadow-lg rounded-lg my-10 inline-block">
                  <div className="flex justify-center md:justify-end -mt-16">
                    <img
                      className="w-20 h-20 object-cover rounded-full border-2 border-indigo-500"
                      src={thumbnail}
